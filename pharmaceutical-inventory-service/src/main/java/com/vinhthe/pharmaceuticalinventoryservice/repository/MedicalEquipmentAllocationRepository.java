...
public interface MedicalEquipmentAllocationRepository extends JpaRepository<MedicalEquipmentAllocationEntity, Long> {
    ...
    Optional<MedicalEquipmentAllocationEntity> findByMedicalEquipmentAndPatientId(
            @Param("medicalEquipment") MedicalEquipmentEntity medicalEquipment, @Param("patientId") String patientId);
}
