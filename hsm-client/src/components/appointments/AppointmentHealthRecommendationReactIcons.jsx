...
const AppointmentHealthRecommendationReactIcons = ({
  appointmentId,
  doctorId,
  patientId,
}) => {
              ...
              <ul className="space-y-2">
                {recommendation.recommendations.map((rec, index) => (
                  <li key={index} className="flex items-start">
                    <FaHeart className="w-5 h-5 text-blue-500 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <ul className="space-y-2">
                  {recommendation.warnings.map((warning, index) => (
                    <li key={index} className="flex items-start">
                      <FaExclamationTriangle className="w-5 h-5 text-yellow-500 mr-3 mt-0.5 flex-shrink-0" />
...
AppointmentHealthRecommendationReactIcons.propTypes = {
  appointmentId: PropTypes.string,
  doctorId: PropTypes.string,
  patientId: PropTypes.string,
};

export default AppointmentHealthRecommendationReactIcons;
