...
const PatientProfileInfo = ({ onEditClick }) => {
  ...
  const fetchPatientProfile = async () => {
    try {
      ...
      console.log("Patient profile data:", data); // Debug log
      setPatient(data);
      setError(null);
    } catch (err) {
    ...
    return (
      <div className="text-center p-8">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Unable to load patient profile information.
        </p>
      </div>
    );
  }
              ...
              <div className="flex items-center mt-1">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    patient.isApproved || patient.approved
                ...
                >
                  {patient.isActive || patient.active ? "Active" : "Inactive"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {getBloodGroupDisplay(patient.bloodGroup)}
                </p>
              </div>
            </div>
          </div>
