...
const EditArticlePage = () => {
  ...
  const fetchArticle = async () => {
    try {
      ...
      setFormData({
        ...
        category: article.category || "GENERAL_HEALTH",
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      setSubmitting(true);
      await axiosInstanceCommunityPortalService.put("/articles/update", {
      ...
      <div className="flex-grow">
        ...
        <div className="articles-page">
          <div className="page-header">
            <div>
              <h1>Edit Article</h1>
              <p>Update the article content using Markdown</p>
            </div>
            <button
            ...
            <form onSubmit={handleSubmit} className="form-card">
              ...
              <div className="form-group">
                ...
                <p className="form-help-text">
                  You can use headings, checklists, links, images, and code blocks.
                </p>
