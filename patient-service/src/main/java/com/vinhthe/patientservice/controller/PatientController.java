...
import com.vinhthe.patientservice.dto.PatientRegistrationResponseDto;
import com.vinhthe.patientservice.dto.ResponseMessageDto;
import com.vinhthe.patientservice.exception.CustomException;
import com.vinhthe.patientservice.service.PatientService;
...
public class PatientController {
    ...
    public ResponseEntity<PatientRegistrationResponseDto> registerPatient(
            @Valid @RequestBody PatientRegistrationRequestDto registrationDto)
        ...
        PatientRegistrationResponseDto responseDto = new PatientRegistrationResponseDto(
                "Patient registered successfully", HttpStatus.CREATED);
    ...
    public ResponseEntity<ResponseMessageDto> updatePatientProfile(@Valid @RequestBody PatientDto patientDto)
        ...
        ResponseMessageDto responseMessageDto = new ResponseMessageDto("Patient profile updated successfully",
                HttpStatus.OK);
