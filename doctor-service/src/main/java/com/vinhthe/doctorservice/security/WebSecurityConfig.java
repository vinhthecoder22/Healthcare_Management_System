package com.vinhthe.doctorservice.security;

import com.vinhthe.doctorservice.constants.AppConstants;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth
                            ...
                            .hasAuthority(AppConstants.ROLE_DOCTOR)
                            .requestMatchers(HttpMethod.DELETE, "/appointments/delete/**")
                            .hasAuthority(AppConstants.ROLE_DOCTOR)
                            .requestMatchers(HttpMethod.GET, "/appointments/book")
                            .hasAuthority(AppConstants.ROLE_PATIENT)
