...
import com.vinhthe.doctorservice.dto.ResponseMessageDto;
import com.vinhthe.doctorservice.dto.RoomDto;
...
import com.vinhthe.doctorservice.service.RoomAllocationService;
...
public class RoomAllocationServiceImplementation implements RoomAllocationService {
    ...
    public void allocateRoom(String doctorId, String roomNo) throws CustomException {
        try {
            ...
            if (roomEntityOptional.isEmpty()) {
                throw new CustomException(new ResponseMessageDto("Room not found", HttpStatus.NOT_FOUND),
                        HttpStatus.NOT_FOUND);
            }
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred while allocating room to doctor",
    ...
    public void deallocateRoom(String doctorId) throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred while deallocating room from doctor",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public void createRoom(RoomDto roomDto) throws CustomException {
        try {
            ...
            if (roomEntityOptional.isPresent()) {
                throw new CustomException(new ResponseMessageDto("Room already exists", HttpStatus.BAD_REQUEST),
            ...
            throw new CustomException(
                    new ResponseMessageDto("Error occurred while creating room", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    public void deleteRoom(Long id) throws CustomException {
        try {
            ...
            throw new CustomException(
                    new ResponseMessageDto("Error occurred while deleting room", HttpStatus.INTERNAL_SERVER_ERROR),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<RoomDto> getAllRooms() throws CustomException {
        try {
            ...
            throw new CustomException(
                    new ResponseMessageDto("Error occurred while getting all rooms", HttpStatus.INTERNAL_SERVER_ERROR),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public RoomDto getRoomByRoomNo(String roomNo) throws CustomException {
        try {
            ...
            throw new CustomException(
                    new ResponseMessageDto("Error occurred while getting room", HttpStatus.INTERNAL_SERVER_ERROR),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<RoomDto> getAvailableRooms() throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred while getting available rooms",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
