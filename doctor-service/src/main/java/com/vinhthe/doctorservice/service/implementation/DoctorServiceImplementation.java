...
import com.vinhthe.doctorservice.entitiy.RoomEntity;
import com.vinhthe.doctorservice.enums.Role;
import com.vinhthe.doctorservice.exception.CustomException;
import com.vinhthe.doctorservice.networkmanager.SecurityServiceFeignClient;
import com.vinhthe.doctorservice.repository.DoctorRepository;
import com.vinhthe.doctorservice.repository.RoomRepository;
...
public class DoctorServiceImplementation implements DoctorService {
        ...
        try {
            ...
            return doctorEntity
                    ...
                    .orElseThrow(() -> new CustomException(
                            new ResponseMessageDto("Token is invalid", HttpStatus.BAD_REQUEST),
                            HttpStatus.BAD_REQUEST));
        } catch (Exception ex) {
    ...
    public void updateDoctorProfile(DoctorDto doctorDto) throws CustomException {
        try {
            ...
            doctorEntity.setFirstName(
                    doctorDto.getFirstName() != null ? doctorDto.getFirstName() : doctorEntity.getFirstName());
            doctorEntity.setLastName(
                    doctorDto.getLastName() != null ? doctorDto.getLastName() : doctorEntity.getLastName());
            doctorEntity.setCareerTitle(
                    doctorDto.getCareerTitle() != null ? doctorDto.getCareerTitle() : doctorEntity.getCareerTitle());
            doctorEntity.setDepartment(
                    doctorDto.getDepartment() != null ? doctorDto.getDepartment() : doctorEntity.getDepartment());
            doctorEntity.setSpecialization(doctorDto.getSpecialization() != null ? doctorDto.getSpecialization()
                    : doctorEntity.getSpecialization());
            doctorEntity.setDesignation(
                    doctorDto.getDesignation() != null ? doctorDto.getDesignation() : doctorEntity.getDesignation());
            doctorEntity.setInstitute(
                    doctorDto.getInstitute() != null ? doctorDto.getInstitute() : doctorEntity.getInstitute());
            doctorEntity.setExperienceYears(doctorDto.getExperienceYears() != null ? doctorDto.getExperienceYears()
                    : doctorEntity.getExperienceYears());
            doctorEntity.setQualifications(doctorDto.getQualifications() != null ? doctorDto.getQualifications()
                    : doctorEntity.getQualifications());
            doctorEntity.setLicenseNumber(doctorDto.getLicenseNumber() != null ? doctorDto.getLicenseNumber()
                    : doctorEntity.getLicenseNumber());
            doctorEntity.setDateOfBirth(
                    doctorDto.getDateOfBirth() != null ? doctorDto.getDateOfBirth() : doctorEntity.getDateOfBirth());
            doctorEntity.setGender(doctorDto.getGender() != null ? doctorDto.getGender() : doctorEntity.getGender());
            doctorEntity.setBloodGroup(
                    doctorDto.getBloodGroup() != null ? doctorDto.getBloodGroup() : doctorEntity.getBloodGroup());
            doctorEntity.setPhoneNumber(
                    doctorDto.getPhoneNumber() != null ? doctorDto.getPhoneNumber() : doctorEntity.getPhoneNumber());
            doctorEntity.setBiography(
                    doctorDto.getBiography() != null ? doctorDto.getBiography() : doctorEntity.getBiography());
            doctorEntity
                    .setAddress(doctorDto.getAddress() != null ? doctorDto.getAddress() : doctorEntity.getAddress());
    ...
    public void approveDoctor(String doctorId, String roomNo) throws CustomException {
        try {
            ...
            if (roomEntity.isEmpty()) {
                throw new CustomException(
                        new ResponseMessageDto("Room not found or not available", HttpStatus.NOT_FOUND),
                        HttpStatus.NOT_FOUND);
            }
    ...
    public List<String> getDoctorDepartmentList() throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during getting doctor department list",
    ...
    public List<DoctorDto> getDoctorListByDepartment(String department) throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during getting doctor list by department",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<DoctorDto> getDoctorList() throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during getting doctor list",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<DoctorDto> getApprovedDoctorList() throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during getting approved doctor list",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public Long countTotalDoctors() throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during counting total doctors",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<DoctorDto> searchDoctorByName(String name) throws CustomException {
        try {
            ...
            List<DoctorEntity> doctorEntityList = doctorRepository
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during searching doctor by name",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public List<DoctorDto> searchDoctorByDepartment(String department) throws CustomException {
        try {
            ...
            throw new CustomException(new ResponseMessageDto("Error occurred during searching doctor by department",
                    HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
