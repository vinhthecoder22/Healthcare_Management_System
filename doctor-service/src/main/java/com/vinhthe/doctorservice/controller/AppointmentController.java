package com.vinhthe.doctorservice.controller;
...
public class AppointmentController {
    ...
    public ResponseEntity<ResponseMessageDto> createAppointmentSlots(@RequestBody AppointmentSlotRequestDto slotRequest)
        ...
        ResponseMessageDto responseMessageDto = new ResponseMessageDto("Appointments created successfully",
                HttpStatus.CREATED);
    ...
    @PostMapping("/book")
    public ResponseEntity<ResponseMessageDto> bookAppointmentSlot(
            @RequestBody BookAppointmentRequestDto bookAppointment)
            throws CustomException {
        ...
        ResponseMessageDto responseMessageDto = new ResponseMessageDto("Appointments booked successfully",
                HttpStatus.CREATED);
    ...
    public ResponseEntity<List<AppointmentDto>> getAppointmentByDoctorIdAndDate(@PathVariable String doctorId,
    ...
    public ResponseEntity<List<DoctorAvailabilityDto>> getDoctorAvailibilityByDoctorIdAndDate(
        ...
        List<DoctorAvailabilityDto> doctorAvailabilityList = doctorAppointmentService
                .getDoctorAvailibilityByDoctorIdAndDate(doctorId, date);
    ...
    public ResponseEntity<ResponseMessageDto> deleteDoctorAvailabilitySlot(@PathVariable Long doctorAvailabilityId)
        ...
        ResponseMessageDto responseMessageDto = new ResponseMessageDto("Doctor availability slot deleted successfully",
                HttpStatus.OK);
    ...
    public ResponseEntity<List<AppointmentDto>> getDoctorBookedAppointmentByDate(@PathVariable String doctorId,
            @PathVariable String date)
            throws CustomException {
        log.info("Received request to get booked appointment by doctor id and date");
        List<AppointmentDto> appointmentList = doctorAppointmentService.getDoctorBookedAppointmentByDate(doctorId,
                date);
        log.info("Appointment fetched successfully");
        return new ResponseEntity<>(appointmentList, HttpStatus.OK);
    }
