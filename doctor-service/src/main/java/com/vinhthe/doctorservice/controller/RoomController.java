...
public class RoomController {
    ...
    public ResponseEntity<ResponseMessageDto> createRoom(@RequestBody RoomDto roomDto)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Room created successfully", HttpStatus.CREATED),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ResponseMessageDto> allocateRoom(@PathVariable String doctorId, @PathVariable String roomNo)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Room allocated successfully", HttpStatus.OK),
                HttpStatus.OK);
    }
}
