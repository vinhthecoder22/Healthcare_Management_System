...
import com.vinhthe.doctorservice.dto.DoctorDto;
import com.vinhthe.doctorservice.dto.DoctorRegistrationRequestDto;
import com.vinhthe.doctorservice.dto.DoctorRegistrationResponseDto;
...
public class DoctorController {
    ...
    public ResponseEntity<DoctorRegistrationResponseDto> registerDoctor(
            @Valid @RequestBody DoctorRegistrationRequestDto doctorRegistrationRequestDto)
        ...
        DoctorRegistrationResponseDto doctorRegistrationResponseDto = new DoctorRegistrationResponseDto(
                "Doctor registered successfully", HttpStatus.CREATED);
    ...
    public ResponseEntity<ResponseMessageDto> updateDoctorProfile(@Valid @RequestBody DoctorDto doctorDto)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Doctor profile updated successfully", HttpStatus.OK),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseMessageDto> approveDoctor(@PathVariable String doctorId, @PathVariable String roomNo)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Doctor approved successfully", HttpStatus.OK),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseMessageDto> approveDoctorAndAllocateRoom(@PathVariable String doctorId,
        ...
        return new ResponseEntity<>(
                new ResponseMessageDto("Doctor approved and room allocated successfully", HttpStatus.OK),
                HttpStatus.OK);
    }
