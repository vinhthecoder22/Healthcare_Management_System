...
import com.vinhthe.communityportalservice.entity.CommentEntity;
...
import com.vinhthe.communityportalservice.repository.CommentRepository;
import com.vinhthe.communityportalservice.repository.PostRepository;
import com.vinhthe.communityportalservice.service.CommentService;
        ...
        try {
            ...
            if (patientDtoResponse.getBody() == null || patientDtoResponse.getStatusCode() != HttpStatus.OK) {
                throw new CustomException(
                        new ResponseMessageDto("You are not authorized to create a comment", HttpStatus.UNAUTHORIZED),
    ...
    public CommentDto getCommentById(Long commentId) throws CustomException {
        try {
            ...
            if (commentEntity.isEmpty() || !commentEntity.get().isActive()) {
                throw new CustomException(new ResponseMessageDto("Comment not found", HttpStatus.NOT_FOUND),
                        HttpStatus.NOT_FOUND);
            }
    ...
    public List<CommentDto> getAllCommentsByPostId(Long postId) throws CustomException {
        try {
            ...
            if (commentEntities.isEmpty()) {
                throw new CustomException(new ResponseMessageDto("No comments found", HttpStatus.NOT_FOUND),
                        HttpStatus.NOT_FOUND);
            }
