...
import com.vinhthe.communityportalservice.entity.VoteEntity;
import com.vinhthe.communityportalservice.enums.VoteType;
...
import com.vinhthe.communityportalservice.repository.VoteRepository;
        ...
        try {
            ...
            if (patientDtoResponse.getBody() == null || patientDtoResponse.getStatusCode() != HttpStatus.OK) {
                throw new CustomException(
                        new ResponseMessageDto("You are not authorized to vote this post", HttpStatus.UNAUTHORIZED),
            ...
            if (existingVote.isPresent() && existingVote.get().isActive()) {
                ...
                if (!vote.getVoteType().equals(voteDto.getVoteType())) {
                    ...
                    throw new CustomException(
                            new ResponseMessageDto("You have already " + vote.getVoteType() + "d this post",
