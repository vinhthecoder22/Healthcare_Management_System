...
import com.vinhthe.communityportalservice.dto.*;
...
import com.vinhthe.communityportalservice.service.VoteService;
...
public class CommunityPortalController {
    ...
    public ResponseEntity<ResponseMessageDto> createPost(@Valid @RequestBody PostDto postDto)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Post created successfully", HttpStatus.CREATED),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ResponseMessageDto> createComment(@Valid @RequestBody CommentDto commentDto)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Comment created successfully", HttpStatus.CREATED),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ResponseMessageDto> castVote(@Valid @RequestBody VoteDto voteDto)
        ...
        return new ResponseEntity<>(new ResponseMessageDto("Voted successfully", HttpStatus.CREATED),
                HttpStatus.CREATED);
    }
